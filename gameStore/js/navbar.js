  ...
  try {
    ...
    if (data.logged_in) {
      ...
      navLinks.innerHTML = `
        ...
        <a href="#" class="sidebar-link logout-link"><span>Logout</span></a>
      `;
      
      // Add logout handler which ensures server-side logout succeeded,
      // clears client cart, and forces a reload
